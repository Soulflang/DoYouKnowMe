...
class DesignableUITextField: UITextField {
    ...
    @IBInspectable var kasseBillede: UIImage? {
        didSet {
            updateView()
        }
    }
...
//
    func updateView() {
        ...
        attributedPlaceholder = NSAttributedString(string: placeholder != nil ?  placeholder! : "", attributes:[NSAttributedStringKey.foregroundColor: hintFarve])
    }
}
